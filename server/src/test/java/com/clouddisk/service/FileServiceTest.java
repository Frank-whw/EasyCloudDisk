...
class FileServiceTest {
    ...
    @Mock
    private FileChunkMappingRepository fileChunkMappingRepository;
    ...
    void setUp() {
        ...
        // Mock fileShareRepository to return empty for all calls
        lenient().when(fileShareRepository.findByFileIdAndOwnerIdAndActiveTrue(anyString(), anyString()))
